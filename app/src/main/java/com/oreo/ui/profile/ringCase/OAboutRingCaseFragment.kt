package com.oreo.ui.profile.ringCase
...
import com.noisefit.luna.databinding.FragmentOAboutRingCaseBinding
...
@AndroidEntryPoint
class OAboutRingCaseFragment : BaseFragment<FragmentOAboutRingCaseBinding>(FragmentOAboutRingCaseBinding::inflate) {
...
//        viewModel.getUserData()
    ...
    override fun subscribeObservers() {
        ...
        viewModel.otaUpdateInfo.observe(this@OAboutRingCaseFragment) {
            it.getContent()?.let {
