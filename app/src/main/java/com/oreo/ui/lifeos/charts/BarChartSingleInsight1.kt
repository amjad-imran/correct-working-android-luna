...
class BarChartSingleInsight1 constructor(context: Context?, attrs: AttributeSet?) :
    ...
    private fun drawContent(canvas: Canvas) {
        ...
        dataStepWidth = availableWidth / barsCount
    ...
    private fun drawBackGrid(canvas: Canvas) {
        ...
        val stepWidth = availableWidth / barsCount
        var start = 0f
    ...
    private fun drawXAxis(canvas: Canvas) {
        ...
        val stepWidth = (width - endPadding) / barsCount
    ...
    fun setDataSet(
        ...
        this.barsCount = xAxisRange.size
