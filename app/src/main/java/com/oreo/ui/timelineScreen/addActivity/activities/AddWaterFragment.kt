...
class AddWaterFragment :
    ...
    private fun setUi() {
        binding.tvSelected.text = getString(R.string.text_water_consumption)
        binding.tvSelected.setTextColor("#8EF1C3".toColorInt())
    ...
    override fun initListener() {
        ...
        binding.lytCard.lytTimePicker.setOnClickListener {
            parentFragment?.setFragmentResultListener(TIME_REQUEST_KEY) { _, bundle ->
                ...
                viewModel.waterIntakeTime.postValue(time)
            ...
            navController.navigate(
                ...
                bundleOf(
                    "hour" to viewModel.waterIntakeTime.value!!.hour,
                    "minute" to viewModel.waterIntakeTime.value!!.minute,
                    "hourOther" to 0,
                    "minuteOther" to 0,
                    "isStart" to 1,
                    "unitPosition" to 1,
