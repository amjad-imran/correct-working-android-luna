...
/**
 * Simple Meal AI screen with an input at the bottom.
 * Animates via standard ConstraintSet + TransitionManager (no MotionLayout).
 */
class MealAiFragment : BaseFragment<FragmentMealAiBinding>(FragmentMealAiBinding::inflate) {
    ...
    private fun animateTextToTopAndFade() {
        ...
        // Make sure target is laid out to fetch its position
        ...
        root.post {
            ...
            // Fade out other elements while text moves
            listOf(binding.tvHeader, binding.tvSub, binding.tvSuggestions, binding.cardInput).forEach { v ->
            ...
            floating.animate()
                ...
                .withEndAction {
                    ...
                    binding.tvTopText.visibility = View.VISIBLE
