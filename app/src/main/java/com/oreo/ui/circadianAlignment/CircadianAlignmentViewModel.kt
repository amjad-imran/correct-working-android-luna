...
@Inject constructor(
    ...
    fun initData() {
         ...
         /*val data =
             "{ \"activities\": [ { \"type\": \"light_exposure\", \"goal\": 120, \"time\": -19756, \"status\": false }, { \"type\": \"meal_window\", \"time\": 14444, \"status\": false }, { \"type\": \"caffeine_window\", \"time\": 44, \"status\": false }, { \"type\": \"workout\", \"time\": 9044, \"goal\": 370, \"status\": false, \"progress\": 8, \"active_calories\": 8, \"total_calories\": 835 }, { \"type\": \"daily_steps\", \"goal\": 5000, \"time\": 9044, \"progress\": 0 } ], \"activity_monitor\": [ { \"type\": \"light_exposure\", \"status\": null }, { \"type\": \"daily_steps\", \"status\": null }, { \"type\": \"meal_window\", \"status\": null }, { \"type\": \"caffeine_window\", \"status\": null }, { \"type\": \"workout\", \"status\": \"partial\" } ], \"chronotype\": { \"type\": \"Moderately evening type\", \"introduction\": \"You’re naturally inclined to be a night owl.\", \"description\": \"Your creativity and focus peak in the afternoon or early evening. Plan for a gentler start and build momentum into your afternoon routines.\" }, \"graph_data\": { \"caffeine_window_graph\": { \"start_time\": \"10:09\", \"end_time\": \"16:09\" }, \"melatonin_prep_phase_window_graph\": { \"start_time\": \"19:39\", \"end_time\": \"22:39\" }, \"dlmo_phase_window_graph\": { \"start_time\": \"22:39\", \"end_time\": \"00:09\" }, \"cortisol_peak_window_graph\": { \"start_time\": \"08:09\", \"end_time\": \"08:39\" }, \"light_anchoring_phase_window_graph\": { \"start_time\": \"08:39\", \"end_time\": \"10:39\" }, \"first_focus_peak_window_graph\": { \"start_time\": \"10:39\", \"end_time\": \"13:39\", \"peak_time\": \"12:09\" }, \"second_focus_peak_window_graph\": { \"start_time\": \"15:39\", \"end_time\": \"18:39\", \"peak_time\": \"17:09\" }, \"sleep_window_opens_graph\": { \"start_time\": \"00:09\" }, \"gh_pulse_window_graph\": { \"start_time\": \"05:39\" }, \"activity_window_graph\": { \"start_time\": \"08:09\", \"end_time\": \"18:39\" }, \"circadian_mid_point\": { \"start_time\": \"2025-10-19 04:00:00\", \"end_time\": \"2025-10-19 06:00:00\", \"circadian_midpoint\": \"2025-10-19 03:53:30\", \"avg_now\": \"2025-10-19 02:28:54\", \"avg_before\": \"2025-10-19 02:07:45\", \"chronotype\": \"Moderately evening type\" }, \"energy_graph\": [ { \"start_time\": \"08:09\", \"energy\": 0 }, { \"start_time\": \"09:09\", \"energy\": 0.011 }, { \"start_time\": \"10:09\", \"energy\": 0.135 }, { \"start_time\": \"11:09\", \"energy\": 0.607 }, { \"start_time\": \"12:09\", \"energy\": 1.004 }, { \"start_time\": \"13:09\", \"energy\": 0.639 }, { \"start_time\": \"14:09\", \"energy\": 0.23 }, { \"start_time\": \"15:09\", \"energy\": 0.181 }, { \"start_time\": \"16:09\", \"energy\": 0.397 }, { \"start_time\": \"17:09\", \"energy\": 0.604 }, { \"start_time\": \"18:09\", \"energy\": 0.364 }, { \"start_time\": \"19:09\", \"energy\": 0.081 }, { \"start_time\": \"20:09\", \"energy\": 0.007 }, { \"start_time\": \"21:09\", \"energy\": 0 }, { \"start_time\": \"22:09\", \"energy\": 0 }, { \"start_time\": \"23:09\", \"energy\": 0 }, { \"start_time\": \"00:09\", \"energy\": 0 } ], \"sleep_data\": { \"bed_time\": \"2025-10-20 00:09:00\", \"wake_time\": \"2025-10-19 08:09:00\" }, \"start_time\": \"2025-10-19 08:09:00\", \"end_time\": \"2025-10-20 00:09:00\" }, \"is_locked\": false }"
        ...
        circadianGraphData?.melatoninPrepPhaseWindowGraph?.let {
            ...
            response.add(
                ClockEvent(
                    ...
                    R.drawable.ic_circadian_wind_down
                )
            )
            circadianGraphData?.lightAnchoringPhaseWindowGraph?.let { it1 ->
        ...
        circadianGraphData?.dlmoPhaseWindowGraph?.let {
            ...
            response.add(
                ClockEvent(
                    ...
                    R.drawable.ic_circadian_dim_light
                )
            )
        }
        ...
        try {
            data.graphData?.let {
                ...
                it.sleepWindowOpensGraph?.let { sleepWindowOpensData ->
                    val startTime =
                        LocalTime.parse(
                            sleepWindowOpensData.startTime,
                            DateTimeFormatter.ofPattern("HH:mm")
                        )
                    val endTime = (LocalDateTime.parse(
                        it.sleepData?.wakeTime,
                        DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")
                    )).toLocalTime()
                    if (currentTime in startTime..endTime) {
