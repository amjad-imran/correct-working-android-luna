...
const val END_WORKOUT_KEY_SHORT = "END_WORKOUT_KEY_SHORT"

@AndroidEntryPoint
class BottomSheetEndWorkoutShort :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvDesc.text = getString(R.string.text_ready_to_end_your_workout_short)
        binding.btnAllow.text = getString(R.string.text_end)
        binding.btnCancel.text = getString(R.string.text_continue)
