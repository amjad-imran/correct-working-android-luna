...
interface NetworkService {
    ...
    @GET
    suspend fun getAiBoosterMealPlans(
        @Url url: String
    ): BaseApiResponse<AiMealResponse>
    ...
    * */
    ...
    @POST
    suspend fun updateCaffeineItemsList(
        @Url url: String,
        @Body req: CaffeinePostApiModel
    ): BaseApiResponse<Any>
    ...
    @POST
    suspend fun submitLogCircadianData(
        @Url url: String,
        @Body req: JsonObject
    ): BaseApiResponse<Any>
    ...
    @GET
    suspend fun getDataSharingVendorList(
        @Url url: String,
    ): BaseApiResponse<List<DataSharingVendorListResponseItem>>
