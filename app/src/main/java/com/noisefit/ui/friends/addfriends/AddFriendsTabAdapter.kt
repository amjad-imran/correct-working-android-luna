...
class AddFriendsTabAdapter( val listener: TabAction) :
    RecyclerView.Adapter<AddFriendsTabAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AddFriendsTabAdapter.ViewHolder {
        val binding =
            RowTabsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AddFriendsTabAdapter.ViewHolder, position: Int) {
