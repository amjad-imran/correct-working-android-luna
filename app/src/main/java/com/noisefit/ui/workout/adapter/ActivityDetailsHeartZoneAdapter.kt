...
class ActivityDetailsHeartZoneAdapter :
    ...
    inner class ViewHolder(val binding: RowHeartRateZoneBinding, val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            RowHeartRateZoneBinding.inflate(LayoutInflater.from(parent.context), parent, false)
