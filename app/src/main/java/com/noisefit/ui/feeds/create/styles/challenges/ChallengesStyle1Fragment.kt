...
@AndroidEntryPoint
class ChallengesStyle1Fragment :
    BaseFragment<FragmentChallengesStyle1Binding>(FragmentChallengesStyle1Binding::inflate) {
    ...
    companion object {
        ...
        fun newInstance(selectedChallenge: ChallengeModel) =
            ChallengesStyle1Fragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val challenge =
            arguments?.getParcelable(SELECTED_CHALLENGE) as? ChallengeModel
