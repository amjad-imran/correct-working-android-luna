...
class ColorSeekBar(context: Context, attributeSet: AttributeSet): View(context, attributeSet){
    ...
    private var colorSeeds = intArrayOf(Color.parseColor("#ffffff"),
        Color.parseColor("#ff0000"),
        Color.parseColor("#ebff00"),
        Color.parseColor("#1dff00"),
        Color.parseColor("#00fff5"),
        Color.parseColor("#1400ff"),
        Color.parseColor("#ce00ff"),
        Color.parseColor("#ff00ba"),
        Color.parseColor("#ff0000"),
