...
@AndroidEntryPoint
class NplWalkAroundBottomDialogFragment :
    ...
    override fun initListener() {
        ...
        binding.btnNext.setOnClickListener {
            ...
            sessionManager.logInsiderAppEvent(InsiderAppEvents.NPL_WALKTHROUGH_NEXT_CLICK)
            binding.vpImageSlider.setCurrentItem(getItem(+1), true)
        }

        binding.btnPrevious.setOnClickListener {
            sessionManager.logInsiderAppEvent(InsiderAppEvents.NPL_WALKTHROUGH_BACK_CLICK)
            binding.vpImageSlider.setCurrentItem(getItem(-1), true)
        }
    }
    ...
    private fun setWalkAround() {
        dismiss()
        localDataStore.setNplWalkAround(true)
    }
    ...
    private fun getWalkAroundDataList(): List<FriendsWalkAround> {
        ...
        friendList.add(
            FriendsWalkAround(
                "Choose your team",
                "Before the prediction timer ends, select your team and submit your prediction.",
                R.drawable.bg_npl_walk_1
            )
        )
        friendList.add(
            FriendsWalkAround(
                "Live scoreboard",
                "Get real time update on the ongoing match and see how your team is performing.",
                R.drawable.bg_npl_walk_2
            )
        )
        friendList.add(
            FriendsWalkAround(
                "Claim your wins",
                "Get exciting rewards with every correct prediction and much more.",
                R.drawable.bg_npl_walk_3
            )
        )
        friendList.add(
            FriendsWalkAround(
                "Streak bonus",
                "Maintaining your step streak along with the right prediction wins you bonus Noise Coins",
                R.drawable.bg_npl_walk_4
            )
        )
