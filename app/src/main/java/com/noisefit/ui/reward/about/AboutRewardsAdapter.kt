...
class AboutRewardsAdapter : RecyclerView.Adapter<AboutRewardsAdapter.ViewHolder>() {
    private var rewardAboutSubCategoryList = ArrayList<RewardAboutSubCategoryList>()
    private var isSubCategory = false
    inner class ViewHolder(val binding: ItemAboutRewardListBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemAboutRewardListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    fun setDataSet(data: List<RewardAboutSubCategoryList>,isSubCategory:Boolean) {
