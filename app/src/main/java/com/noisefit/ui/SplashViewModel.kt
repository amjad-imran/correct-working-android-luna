...
enum class AppLinks {
    REFERRAL, NOTIFICATION_CONTROL, PROFILE, SLEEP_PLANNER, DASHBOARD, LUNA_AI,LUNA_SETTINGS, FEATURE_REQUEST, FEMALE_HEALTH, CAFFEINE_WINDOW,
    ...
    CIRCADIAN_PAGE, STRESS_DETAIL, HR_DETAIL, TIMELINE_LIST, LOG_HABITS
}