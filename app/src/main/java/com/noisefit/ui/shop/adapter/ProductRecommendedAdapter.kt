...
import com.noisefit.luna.databinding.RowRecommendedProductBinding
import com.noisefit_commans.ui.getCircleProgressDrawable
import com.noisefit_commans.ui.gone
import com.noisefit_commans.ui.visible

class ProductRecommendedAdapter(val listener: ProductAction) : RecyclerView.Adapter<ProductRecommendedAdapter.ViewHolder>() {
    private val mDataSet = ArrayList<ShopProduct>()

    inner class ViewHolder(val binding: RowRecommendedProductBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            RowRecommendedProductBinding.inflate(LayoutInflater.from(parent.context), parent, false)
