...
import com.noisefit.luna.databinding.RowSearchProductBinding
import com.noisefit_commans.ui.getCircleProgressDrawable
import com.noisefit_commans.ui.gone
import com.noisefit_commans.ui.visible

class SearchProductAdapter(val listener: ProductAction) :
    RecyclerView.Adapter<SearchProductAdapter.ViewHolder>() {
    private val mDataSet = ArrayList<ShopProduct>()

    inner class ViewHolder(val binding: RowSearchProductBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            RowSearchProductBinding.inflate(LayoutInflater.from(parent.context), parent, false)
