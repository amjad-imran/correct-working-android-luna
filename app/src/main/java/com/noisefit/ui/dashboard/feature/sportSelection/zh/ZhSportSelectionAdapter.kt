...
class ZhSportSelectionAdapter(private val action: SportSelectionListener) :
    RecyclerView.Adapter<ZhSportSelectionAdapter.ViewHolder>(), ItemMoveCallbackListener.Listener {
