...
import com.noisefit.luna.databinding.FragmentEditMedicineReminderBinding
import com.noisefit_commans.ui.BaseFragment
import com.noisefit.ui.common.bottomSheet.TIME_REQUEST_KEY
import com.noisefit.ui.common.bottomSheet.VALUE_REQUEST_KEY
import com.noisefit_commans.ui.gone
import com.noisefit_commans.ui.showShortToast
import com.noisefit.ui.dashboard.feature.healthMonitor.meal.EditMealReminderFragmentArgs
...
const val EDIT_MEDICINE_REQUEST_KEY = "EDIT_MEDICINE_REQUEST_KEY"

@AndroidEntryPoint
class EditMedicineReminderFragment :
    BaseFragment<FragmentEditMedicineReminderBinding>(FragmentEditMedicineReminderBinding::inflate) {
    ...
    override fun initListener() {
        ...
        binding.lytToolbarWithDetails.apply {
            tvTitle.text = getString(R.string.text_medicine_reminder_settings)
        ...
        binding.lytEditReminder.tvEndTimeData.setOnClickListener {
            ...
            navigate(
                EditMedicineReminderFragmentDirections.actionEditMedicineReminderFragmentToTimeBottomSheet(
                    viewModel.sedentaryData.endHour,
                    viewModel.sedentaryData.endMinute,
                    1,
        ...
        binding.lytEditReminder.tvFreqData.setOnClickListener {
            ...
            navigate(
                EditMedicineReminderFragmentDirections.actionEditMedicineReminderFragmentToValueSelectorBottomSheet(
                    viewModel.getFrequencyValue(viewModel.sedentaryData.interval),
            ...
            when (event) {
                is UpdateDeviceDataCallback.MedicineDataUpdated -> {
                    ...
                    if (event.success) {
                        ...
                        setFragmentResult(
                            EDIT_MEDICINE_REQUEST_KEY,
                            bundleOf("medicine" to viewModel.sedentaryData)
                        )
                        navigateUpSafe()
                    }
                }
