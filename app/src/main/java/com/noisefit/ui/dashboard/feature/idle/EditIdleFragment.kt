...
const val EDIT_IDLE_REQUEST_KEY = "EDIT_IDLE_REQUEST_KEY"

@AndroidEntryPoint
class EditIdleFragment :
    BaseFragment<FragmentEditIdleBinding>(FragmentEditIdleBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            viewModel.setSedentary(EditIdleFragmentArgs.fromBundle(it).reminder)
        }
...
//        }
    ...
    override fun initListener() {
        ...
        binding.lytToolbarWithDetails.apply {
            tvTitle.text = getString(R.string.text_idle_alert_settings)
        ...
        binding.lytEditReminder.tvEndTimeData.setOnClickListener {
            ...
            navigate(
                EditIdleFragmentDirections.actionEditIdleFragmentToTimeBottomSheet(
                    viewModel.sedentaryData.endHour,
                    viewModel.sedentaryData.endMinute,
                    1,
        ...
        binding.lytEditReminder.tvFreqData.setOnClickListener {
            ...
            navigate(
                EditIdleFragmentDirections.actionEditIdleFragmentToValueSelectorBottomSheet(
                    viewModel.getFrequencyValue(viewModel.sedentaryData.interval),
        ...
        binding.lytEditReminder.tvRepeatData.setOnClickListener {
            ...
            navigate(
                EditIdleFragmentDirections.actionEditIdleFragmentToRepeatBottomSheet(
            ...
            when (event) {
                is UpdateDeviceDataCallback.SedentaryDataUpdated -> {
                    ...
                    if (event.success) {
                        ...
                        setFragmentResult(
                            EDIT_IDLE_REQUEST_KEY,
                            bundleOf("ideal" to viewModel.sedentaryData)
                        )
                        navigateUpSafe()
                    }
                }
