...
@AndroidEntryPoint
class MealReminderFragment :
    BaseFragment<FragmentMealReminderBinding>(FragmentMealReminderBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!viewModel.firstTimeData) {
            ...
            viewModel.sessionManager.sendQueryAction(QueryAction.GetMealReminderSettings)
        } else {
    ...
    override fun initListener() {
        binding.lytReminderSettings.tvEdit.setOnClickListener {
            setFragmentResultListener(EDIT_MEAL_REQUEST_KEY) { _, bundle ->
                val sedentaryData = bundle.getParcelable("meal") as? SedentaryData
            ...
            navigate(
                MealReminderFragmentDirections.actionMealReminderFragmentToEditMealReminderFragment(
        ...
        binding.lytFeatureTile.apply {
            imvIcon.loadImage(requireContext(), R.drawable.ic_meal_reminder)
            tvTitle.text = getString(R.string.text_meal_reminder)
        ...
        binding.lytToolbarWithDetails.apply {
            tvTitle.text = getString(R.string.text_meal_reminder)
            tvDesc.text = getString(R.string.tet_allow_your_device_to_take_meal)
    ...
    override fun subscribeObservers() {
        ...
        viewModel.sessionManager.deviceQueryCallback.observe(this) {
            when (it) {
                is QueryCallback.MealDataObtained -> {
