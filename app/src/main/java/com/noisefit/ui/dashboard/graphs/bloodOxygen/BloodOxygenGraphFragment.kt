...
import com.noisefit.luna.databinding.FragmentBloodOxygenGraphBinding
...
@AndroidEntryPoint
class BloodOxygenGraphFragment :
    BaseFragment<FragmentBloodOxygenGraphBinding>(FragmentBloodOxygenGraphBinding::inflate),
    OnChartValueSelectedListener {

    private val viewModel: BloodOxygenGraphViewModel by viewModels()
        ...
        binding.barChart.post({
            nullableBinding?.let {
                if (dataList != null) {
                    ...
                    StepsChartUtils.setInvalidate(binding.barChart)
                }
            }
        })
        ...
        binding.lytGraphDetailsHeader.apply {
            ...
            viewModel.steps.toString().replaceUnderScore().apply {
                if (this.isUnderScore()) {
                    ...
                    tvUnitEnd.text = StressBarChartUtils.bloodOxygenType(viewModel.steps)
...
//        LOGS.d("asdassaddsa ${totalMargin} ${markerView!!.measuredWidth} ${binding.barChart.width}")
    ...
    companion object {
        @JvmStatic
        fun newInstance(
            boDataList: List<BoHistory>,
            historyType: String,
            range: String,
            date: String,
            steps: Int
        ) =
            BloodOxygenGraphFragment().apply {
                arguments = Bundle().apply {
                    putParcelableArrayList(ARG_PARAM1, boDataList as ArrayList)
