...
@HiltViewModel
class BloodOxygenGraphViewModel
@Inject
constructor(
    ...
    var stressDataList: ArrayList<BoHistory> = ArrayList()
    ...
    private fun getMonthList(stressDataList: ArrayList<BoHistory>): ArrayList<String> {
    ...
    private fun getWeekly(stressDataList: ArrayList<BoHistory>): ArrayList<String> {
        val monthlyList = ArrayList<String>()
        stressDataList.forEach { stepData ->
            if (stepData.date != null) {
    ...
    private fun getEmptyHourList(): Triple<ArrayList<BarEntry>, ArrayList<Int>, ArrayList<MarkerEntry>> {
        ...
        for (i in 0..23) {
            ...
            colors.add(NoiseFitApplicationMain.context!!.resources.getColor(R.color.blood_oxygen_color))
    ...
    fun parseGraph(
        stressDataList: ArrayList<BoHistory>,
        ...
        when (graphInterval) {
            GraphInterval.YEAR -> {
                ...
                stressDataList.forEachIndexed { index, stepData ->
                    ...
                    markerEntry.type = StressBarChartUtils.bloodOxygenType(count)
