...
interface ProgressView {
    ...
    companion object {
        ...
        val KEY_USER_PROGRESS = " com.noise.customprogress.api.view.KEY_USER_PROGRESS"
        val KEY_DRAWN_PROGRESS = " com.noise.customprogress.api.view.KEY_DRAWN_PROGRESS"
        val KEY_STRIPED = " com.noise.customprogress.api.view.KEY_STRIPED"
        val KEY_ANIMATED = " com.noise.customprogress.api.view.KEY_ANIMATED"
        val KEY_PROGRESS_BG = " com.noise.customprogress.api.view.KEY_PROGRESS_BG"
    }
}
