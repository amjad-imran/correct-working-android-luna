package com.noise.customprogress;
...
import com.noise.customprogress.api.defaults.DefaultStrippedBrand;
import com.noise.customprogress.api.defaults.DefaultStrippedSize;
import com.noise.customprogress.api.traits.ProgressView;
import com.noise.customprogress.api.traits.RoundableView;
import com.noise.customprogress.api.traits.StrippedBrandView;
import com.noise.customprogress.api.traits.StrippedSizeView;
import com.noise.customprogress.utils.ColorUtils;
import com.noise.customprogress.utils.DimenUtils;
...
public class StrippedProgressBar extends View implements ProgressView, StrippedBrandView, StrippedSizeView, RoundableView, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    ...
    private void initialise(AttributeSet attrs) {
        ...
        textPaint.setColor(ColorUtils.Companion.resolveColor(android.R.color.white, getContext()));
    ...
    private void updateStrippedState() {
        int color =getResources().getColor(R.color.stripped_line_color) /*bootstrapBrand.defaultFill(getContext())*/;
