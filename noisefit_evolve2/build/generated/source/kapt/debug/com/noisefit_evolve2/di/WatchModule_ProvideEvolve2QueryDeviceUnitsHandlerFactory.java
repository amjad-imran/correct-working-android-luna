...
public final class WatchModule_ProvideEvolve2QueryDeviceUnitsHandlerFactory implements Factory<Evolve2QueryDeviceUnitsHandler> {
  ...
  public WatchModule_ProvideEvolve2QueryDeviceUnitsHandlerFactory(
  ...
  public Evolve2QueryDeviceUnitsHandler get() {
    return provideEvolve2QueryDeviceUnitsHandler(evolve2ApplicationHandlerProvider.get(), dataConverterProvider.get(), contextProvider.get(), watchDataStoreProvider.get());
  }

  public static WatchModule_ProvideEvolve2QueryDeviceUnitsHandlerFactory create(
      Provider<Evolve2ApplicationHandler> evolve2ApplicationHandlerProvider,
      Provider<DataConverter> dataConverterProvider, Provider<Context> contextProvider,
      Provider<WatchDataStore> watchDataStoreProvider) {
    return new WatchModule_ProvideEvolve2QueryDeviceUnitsHandlerFactory(evolve2ApplicationHandlerProvider, dataConverterProvider, contextProvider, watchDataStoreProvider);
  }

  public static Evolve2QueryDeviceUnitsHandler provideEvolve2QueryDeviceUnitsHandler(
    ...
    return Preconditions.checkNotNullFromProvides(WatchModule.INSTANCE.provideEvolve2QueryDeviceUnitsHandler(evolve2ApplicationHandler, dataConverter, context, watchDataStore));
  }
}
