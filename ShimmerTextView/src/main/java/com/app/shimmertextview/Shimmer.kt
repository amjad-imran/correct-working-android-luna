...
class Shimmer {
    ...
    abstract class Builder<T : Builder<T>> {
        ...
        open fun consumeAttributes(typedArray: TypedArray): T {
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_clip_to_children)) {
                setClipToChildren(typedArray.getBoolean(R.styleable.ShimmerTextView_text_shimmer_clip_to_children,
                    shimmer.clipToChildren))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_auto_start)) {
                setAutoStart(typedArray.getBoolean(R.styleable.ShimmerTextView_text_shimmer_auto_start,
                    shimmer.autoStart))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_base_alpha)) {
                setBaseAlpha(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_base_alpha,
                    0.3F))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_highlight_alpha)) {
                setHighlightAlpha(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_highlight_alpha,
                    1F))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_duration)) {
                setDuration(typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_duration,
                    shimmer.animationDuration.toInt()).toLong())
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_repeat_count)) {
                setRepeatCount(typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_repeat_count,
                    shimmer.repeatCount))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_repeat_delay)) {
                setRepeatDelay(typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_repeat_delay,
                    shimmer.repeatDelay.toInt()).toLong())
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_repeat_mode)) {
                setRepeatMode(typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_repeat_mode,
                    shimmer.repeatMode))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_start_delay)) {
                setStartDelay(typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_start_delay,
                    shimmer.startDelay.toInt()).toLong())
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_direction)) {
                when (typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_direction,
                    shimmer.direction)) {
            ...
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_shape)) {
                when (typedArray.getInt(R.styleable.ShimmerTextView_text_shimmer_shape, shimmer.shape)) {
                    Shape.LINEAR -> {
            ...
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_dropoff)) {
                setDropOff(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_dropoff,
                    shimmer.dropOff))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_fixed_width)) {
                setFixedWidth(typedArray.getDimensionPixelSize(R.styleable.ShimmerTextView_text_shimmer_fixed_width,
                    shimmer.fixedWidth))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_fixed_height)) {
                setFixedHeight(typedArray.getDimensionPixelSize(R.styleable.ShimmerTextView_text_shimmer_fixed_height,
                    shimmer.fixedHeight))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_intensity)) {
                setIntensity(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_intensity,
                    shimmer.intensity))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_width_ratio)) {
                setWidthRatio(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_width_ratio,
                    shimmer.widthRatio))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_height_ratio)) {
                setHeightRatio(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_height_ratio,
                    shimmer.heightRatio))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_tilt)) {
                setTilt(typedArray.getFloat(R.styleable.ShimmerTextView_text_shimmer_tilt, shimmer.tilt))
            }

            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_colored)) {
                setColored(
                    typedArray.getBoolean(R.styleable.ShimmerTextView_text_shimmer_colored, shimmer.isColored)
                )
            }
    ...
    class ColorHighlightBuilder : Builder<ColorHighlightBuilder>() {
        ...
        override fun consumeAttributes(typedArray: TypedArray): ColorHighlightBuilder {
            ...
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_base_color)) {
                setBaseColor(
                    typedArray.getColor(R.styleable.ShimmerTextView_text_shimmer_base_color,
                        shimmer.baseColor))
            }
            if (typedArray.hasValue(R.styleable.ShimmerTextView_text_shimmer_highlight_color)) {
                setHighlightColor(
                    typedArray.getColor(
                        R.styleable.ShimmerTextView_text_shimmer_highlight_color,
