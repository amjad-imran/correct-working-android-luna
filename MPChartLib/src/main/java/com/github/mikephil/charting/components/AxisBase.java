...
public abstract class AxisBase extends ComponentBase {
    ...
    private boolean showMiddleGrid = false;
    private float mGridLineWidth = 1f;

    private int mAxisLineColor = Color.GRAY;
    private int[] mGridCustomColor = new int[]
            {};
    ...
    public void setShowMiddleGrid(boolean show) {
        this.showMiddleGrid = show;
    }

    public boolean isShowMiddleGrid() {
        return showMiddleGrid;
    }
    ...
    public void setGridCustomColor(int[] color) {
        mGridCustomColor = new int[color.length];
        if (color.length > 0) {
            for (int i = 0; i < color.length; i++) {
                mGridCustomColor[i] = color[i];
            }
        }
    ...
    public int[] getCustomGridColor() {
        return mGridCustomColor;
    }
...
//        Log.d("drawLabels","AxisBase");
//        for (float data : mEntries){
//            Log.d("drawYLabels","drawYLabels data:: "+data);
//        }
    ...
    public void setAxisMinimum(float min) {
        ...
        Log.d("setAxisMinimum", " " + mAxisMinimum + " " + min + " " + this.mAxisRange);
    }
    ...
    public void calculate(float dataMin, float dataMax) {
        ...
        Log.d("calculate", "calculate " + min + " " + max);
