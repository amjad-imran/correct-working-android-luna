...
public class YAxisRenderer extends AxisRenderer {
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        for (int i = from; i < to; i++) {
           ...
           // Log.d("drawYLabels", "drawYLabels " + xOffset + " " + text);
            c.drawText(text,
    ...
    public void renderGridLines(Canvas c) {
        ...
        if (mYAxis.isDrawGridLinesEnabled()) {
            ...
            float lineWidth = mYAxis.getGridLineWidth();
            ...
            for (int i = 0; i < positions.length; i += 2) {
                ...
                if (i == 2 && mYAxis.isShowMiddleGrid()) {
                    ...
                    mYAxis.setGridDashedLine(new DashPathEffect(new float[]{
                            10f, 15f
                    }, 0f));

                } else {
                    mGridPaint.setStrokeWidth(lineWidth);
                    mYAxis.setGridDashedLine(null);
