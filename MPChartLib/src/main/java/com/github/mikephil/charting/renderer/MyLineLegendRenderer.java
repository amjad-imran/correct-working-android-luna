...
//            if (currentEntry.getY()<1) {//不可见时,闭合路径
...
//                    if (entry.getY()<1) continue;
//                    if (dataSet.isDrawValuesEnabled()) {
////                        drawValue(c, dataSet.getValueFormatter(), entry.getY(), entry, i, x,
////                                y - valOffset, dataSet.getValueTextColor(j / 2));
//                        drawValue(c, dataSet.getValueFormatter(), x, y - valOffset, dataSet.getValueTextColor(j / 2));
//                        drawValue(c, dataSet.getValueFormatter(), entry.getY(), entry, i, x,
//                                y - valOffset, dataSet.getValueTextColor(j / 2));
//                    }
