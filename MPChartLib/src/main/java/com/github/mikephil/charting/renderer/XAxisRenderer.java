...
//                for(Float entry:mXAxis.mEntries){
//                    Log.d("drawLabels", "XAxisRenderer " + entry);
//                }


                String label = mXAxis.getValueFormatter().getFormattedValue(mXAxis.mEntries[i / 2], mXAxis);
//                Log.d("drawLabels32123", "XAxisRenderer " + label);
...
//            Log.d("drawLine 1", "drawLine" + positions[i] + "" + i + " " + positions.length);
