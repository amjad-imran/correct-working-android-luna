...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean showLastCircle = false;
    private boolean showMaxCircle = false;

    private int maxOrLastCircleColor = -1;
    private boolean hideZeroPoints = false;
    /**
    ...
    @Override
    public int getMaxOrLastCircleColor() {
        return maxOrLastCircleColor;
    }

    public void setMaxOrLastCircleColor(int maxOrLastCircleColor1) {
        Log.d("maxCircle", maxOrLastCircleColor1 + "  dfsfsd");
        this.maxOrLastCircleColor = maxOrLastCircleColor1;
    }

    @Override
    public boolean isShowLastCircle() {
        return showLastCircle;
    }


    public void setShowLastCircle(boolean showLastCircle) {
        this.showLastCircle = showLastCircle;
    }

    @Override
    public boolean isShowMaxCircle() {
        return showMaxCircle;
    }

    public void setShowMaxCircle(boolean showMaxCircle) {
        this.showMaxCircle = showMaxCircle;
    }
    ...
    @Override
    public boolean isHideZeroPoints() {
        return hideZeroPoints;
    }

    public void setHideZeroPoints(boolean hideZeroPoints) {
        this.hideZeroPoints = hideZeroPoints;
    }
