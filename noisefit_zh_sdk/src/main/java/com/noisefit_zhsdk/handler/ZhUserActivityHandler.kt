    ...
    private val fitnessDataCallBack: FitnessDataCallBack =
        object : FitnessDataCallBack {
            ...
            override fun onRingSleepNAP(p0: MutableList<RingSleepNapBean>?) {
                ...
                //val dummyNap = Gson().fromJson<List<RingSleepNapBean>>("[{\"existSleepNap\":true, \"asleepNapTime\":1705433400, \"wakeupNapTime\":1705437000, \"sleepNapDuration\":3600, \"date\":\"2024-01-17 00:00:00\"}]")
